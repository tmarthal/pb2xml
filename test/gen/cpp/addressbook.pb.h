...
class Person : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_awesome() const;
  inline void clear_awesome();
  static const int kAwesomeFieldNumber = 5;
  inline bool awesome() const;
  inline void set_awesome(bool value);
...
// required bool awesome = 5;
inline bool Person::has_awesome() const {
  return _has_bit(4);
}
inline void Person::clear_awesome() {
  awesome_ = false;
  _clear_bit(4);
}
inline bool Person::awesome() const {
  return awesome_;
}
inline void Person::set_awesome(bool value) {
  _set_bit(4);
  awesome_ = value;
}
