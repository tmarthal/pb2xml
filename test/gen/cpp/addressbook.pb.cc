...
void protobuf_AssignDesc_addressbook_2eproto() {
  ...
  static const int Person_offsets_[5] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Person, awesome_),
  };
  Person_reflection_ =
...
const int Person::kAwesomeFieldNumber;
#endif  // !_MSC_VER
      ...
      case 4: {
       ...
       parse_phone:
        DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
              input, add_phone()));
        if (input->ExpectTag(34)) goto parse_phone;
        if (input->ExpectTag(40)) goto parse_awesome;
        break;
      }
      
      // required bool awesome = 5;
      case 5: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) !=
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
          goto handle_uninterpreted;
...
void Person::SerializeWithCachedSizes(
  ...
  // required bool awesome = 5;
  if (_has_bit(4)) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(5, this->awesome(), output);
  }
...
::google::protobuf::uint8* Person::SerializeWithCachedSizesToArray(
  ...
  // required bool awesome = 5;
  if (_has_bit(4)) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(5, this->awesome(), target);
  }
...
void Person::Swap(Person* other) {
  if (other != this) {
    ...
    std::swap(awesome_, other->awesome_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
